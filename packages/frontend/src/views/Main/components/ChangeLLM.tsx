...
import { aichatModelConfigs, modelConfigs } from '../../../services/apikey/apikey_ls.service';
...
export function ChangeLLM({
	...
	const modelChoices = type === 'aichat' ? aichatModelConfigs : modelConfigs;
