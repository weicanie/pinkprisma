		...
		<section id="pricing" aria-label="Pricing" className="bg-slate-900 py-20 sm:py-32">
			<Container>
				<div className="mx-auto max-w-2xl text-center">
					...
					<p className="mt-4 text-lg text-slate-600">选择最适合您的方案，开始您的面试准备之旅。</p>
				</div>
				<div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
					<Plan
						name="免费版"
						price="$0"
						description="适合初学者和轻度使用者"
						href="/register"
						features={['基础题库访问', '每日 5 次 AI 分析', '社区讨论参与', '基础学习统计']}
					/>
					<Plan
						featured
						name="专业版"
						price="$9"
						description="适合认真准备面试的开发者"
						href="/register"
						features={[
							'完整题库访问',
							'无限 AI 分析',
