...
const features: Array<Feature> = [
	{
		name: '上传或导入',
		summary: '分享您的面试经历，或在我们的数据库中搜索您感兴趣的公司和岗位。',
		description:
			'我们提供了便捷的上传功能，让您可以轻松分享面试经验，同时也可以获取其他用户分享的宝贵经验。',
		image: screenshot1,
	...
	{
		name: 'AI 分析与整理',
		summary: '我们的 AI Agent 会自动为面经生成答案、导图、文档溯源。',
		description:
			'先进的 AI 技术帮助您自动分析面试内容，生成标准答案与思维导图，并进行文档溯源，让学习更加系统化。',
		image: screenshot2,
	...
	{
		name: '学习与导出',
		summary: '在线学习，或将您的题库一键导出到 Anki，随时随地巩固知识。',
		description:
			'支持多种学习方式，既可以在线学习，也可以导出到 Anki 支持多端同步，让您可以随时随地进行复习和巩固。',
		image: screenshot3,
